...
communities <- readxl::read_excel("docs/arc-d/comunity_member_district_region.xlsx")%>%mutate(member =str_to_lower(member))
...
arcd <- function(input ,output , session,sharedValues){
  ns1 <- NS("arcd")
